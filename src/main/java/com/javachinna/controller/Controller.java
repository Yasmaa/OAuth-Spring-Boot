...
public class Controller {
	...
	@GetMapping({ "/", "/home" })
	public ModelAndView home(@RequestParam(value = "view", required = false) String view, HttpServletRequest request) {
	...
	@GetMapping("/signout")
	public ModelAndView logout(@RequestParam(value = "view", required = false) String view) {
		ModelAndView model = new ModelAndView("logout");
		return model;
	}

	@GetMapping("/expiredSession")
	public ModelAndView expired(@RequestParam(value = "view", required = false) String view) {
